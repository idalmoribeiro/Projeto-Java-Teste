...
public class CursoBateria extends Curso {
	...
	//construtores
	public CursoBateria(String nome, int duracao_Meses, int numero_Alunos, String professor) {
		super(nome, duracao_Meses, numero_Alunos, professor);
	}

	@Override
	public void iniciarCurso() {
		// iniciar lógica do curso de bateria (sem I/O)
	}

	@Override
	public void encerrarCurso() {
		// encerrar lógica do curso de bateria (sem I/O)
	}
